...
//TODO : Device ID of the slave

//TODO : This will come from Master to UART Rx of Slave
...
uint32_t calculateOutputCrc(uint32_t *,uint32_t rPacketLen);

// Creating packet to send the data back to Master as requested
//extern uint32_t arrayResponsePacket[50] = { 0 };
//extern uint32_t arrayResponsePacket;
//extern uint32_t *rPacket; 

//Register heap data storing function declaration
...
void addData(uint32_t user_id, uint32_t *name);
void putData();
