...
{
  // enable vfp
  // ref: http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.ddi0439d/BEHBJHIG.html
  u32 CPACR_REG_ADDR = 0xE000ED88;
  *(volatile u32*)CPACR_REG_ADDR = ((3UL << 10*2)|(3UL << 11*2));
